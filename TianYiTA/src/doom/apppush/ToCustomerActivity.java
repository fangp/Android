...
public class ToCustomerActivity extends Activity
{
...
//                }  
                ...
                for(int i=0;i<recommend.size();i++){  
                    ...
                    if (strContent.length() > 70) {  
                        ...
                        smsManager.sendTextMessage(recommend.get(i), null, strContent, sentIntent, null);  
                    }     
                }  
                Toast.makeText(context, "短信发送成功", Toast.LENGTH_LONG).show();
                ToCustomerActivity.this.finish();
            }
        });
        MakeMessage();
    }
