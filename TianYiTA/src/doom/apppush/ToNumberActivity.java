...
public class ToNumberActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		send_btn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
                ...
                PendingIntent sentIntent = PendingIntent.getBroadcast(ToNumberActivity.this, 0, new Intent(), 0);  
...
//                }  
                ...
                for(int i=0;i<number.size();i++){  
                    ...
                    if (strContent.length() > 70) {  
                        ...
                        smsManager.sendTextMessage(number.get(i), null, strContent, sentIntent, null);  
                    }     
                }  
                Toast.makeText(ToNumberActivity.this, "短信发送成功", Toast.LENGTH_LONG).show(); 
                ToNumberActivity.this.finish();
			}
	...
	private String Message(){
		...
		MsgConfigService msgconfigservice = new MsgConfigService(context);
		greeting = msgconfigservice.ShowMsg();
		Intent intent = this.getIntent();
		SerializableMap map = (SerializableMap)intent.getSerializableExtra("selectedApp");
		mapp = map.getMap();
